...
///
/// Aucun écran intermédiaire de « résolution de session » : la session
/// Supabase est déjà restaurée de façon synchrone à ce stade
/// ([SupabaseAuthRepository.currentUser], fourni en `initialData`), et le
/// flux ne sert plus qu'à réagir aux connexions/déconnexions ultérieures.
/// L'utilisateur passe donc directement de l'écran de démarrage animé à sa
/// destination, sans indicateur de chargement entre les deux.
